  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 p-4 font-sans text-zinc-100">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[60%] -right-[10%] w-[40%] h-[40%] rounded-full bg-cyan-600/20 blur-[120px]" />
      </div>
      ...
      <div className="relative w-full max-w-md z-10">
        <div className="backdrop-blur-xl bg-zinc-900/50 border border-zinc-800 p-8 rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-cyan-400">
              Create an Account
            </h1>
          ...
          <form action={action} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full bg-zinc-950/50 border border-zinc-800 rounded-xl px-4 py-3 text-zinc-200 placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500 transition-all duration-300 group-hover:border-zinc-700"
                />
              </div>
              {state?.errors?.name && (
                <p className="text-rose-400 text-xs ml-1 font-medium">{state.errors.name[0]}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {state?.errors?.password && (
                <div className="text-rose-400 text-xs ml-1 font-medium space-y-1">
